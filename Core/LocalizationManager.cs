...
public sealed class LocalizationManager : INotifyPropertyChanged
{
    ...
    public string ProfileAppliedStatus => S("„{0}“ wurde auf {1} Erweiterungen angewendet – auf „OK“ klicken, um zu speichern.", "“{0}” was applied to {1} extensions – click “OK” to save.", "« {0} » a été appliqué à {1} extensions – cliquez sur « OK » pour enregistrer.", "«{0}» è stato applicato a {1} estensioni – fai clic su «OK» per salvare.", "«{0}» se aplicó a {1} extensiones – haz clic en «OK» para guardar.");
}
